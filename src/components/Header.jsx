    ...
    <header className="fixed top-0 left-0 w-full z-50 py-4 bg-black">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="flex space-x-9">
          <a className="text-white font-semibold hover:text-yellow-600 cursor-pointer transition-colors duration-200">
            HOME
          </a>
          <a className="text-white font-semibold hover:text-yellow-600 cursor-pointer transition-colors duration-200">
            ABOUT
        ...
        <div className="flex items-center space-x-12">
          ...
          <button
            ...
            className="bg-yellow-600 text-black font-semibold px-4 py-1 rounded hover:bg-yellow-400 transition-colors duration-200"
          >
            Logout
          </button>
        </div>
