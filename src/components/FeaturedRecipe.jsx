...
const FeaturedRecipe = () => {
    ...
    return (
        <>
        <h1 className="ml-13 font-bold text-black text-xl font-sans">Featured Recipes</h1>
                ...
                {recipes.map ((recipe) => (
                    <div key={recipe.idMeal} className="p-3">
                        <div className="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                            <img src={recipe.strMealThumb} alt={recipe.strMeal} className="w-full h-52 object-cover" />\
                            <div className="p-4">
                                <h3 className="text-lg font-semibold text-gray-800 truncate">
                                    {recipe.strMeal}
                                </h3>
                                <p className="text-sm text-gray-500 mt-1">By Chef {recipe.strArea}</p>
